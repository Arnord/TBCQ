...
from TBCQ.common.penaltys.demo_penalty import DemoPenalty
from TBCQ.simulation import utils
from TBCQ.utils.utils import set_random_seed
...
class BaseEnv():
    ...
    # Define the boundary of the target variable
    ...
    def solve_u(self, u):
        ...
        if bound_res_u[0] != 0:
            self.done = True             # u到达边界后done为True
        return bound_res_u
